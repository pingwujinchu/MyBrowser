...
public class AboutDialog extends JDialog {
    public AboutDialog(Frame owner) {
        super(owner, "About MyBrowser", true);
        initContent();
        initKeyStroke();
        setResizable(false);
        pack();
    ...
    private void initContent() {
        ...
        aboutText.setText("<html><font face='Arial' size='3'>" +
                "<font size='6'>MyBrowser</font><br><br>" +
                "<b>Version "  + "</b><br><br>" +

                "This application is created for demonstration purposes only.<br>" +
                "&copy; 2016 TeamDev Ltd. All rights reserved.<br><br>" +

                "Powered by <a color='#3d82f8' href='www.baidu.com' " +
                "style='text-decoration:none'>Fan</a>. See " +
                ...
                "This demo uses <a color='#3d82f8' href='https://webkit.org' " +
                "style='text-decoration:none'>WebKit</a> project under LGPL.<br>" +
